...
class Movie():
    """A movie class that inherits the attributes of video class.
...
class TvShow():
    """A tv-show class that inherits the attributes of video class.
        A tv-show has the following attributes:
        (Video) title: Title of the video
        (Video) storyline: A description of the video
        (Video) poster_image: A background image for the video
        (Video) trailer_youtube: Trailer of the video
        (tv-show) show_seasons: How many seasons does the tv-show have
    """
    def __init__(self, title, storyline,
                 poster_image, trailer_youtube, show_seasons):
            Video.__init__(self, title, storyline,
                           poster_image, trailer_youtube)
