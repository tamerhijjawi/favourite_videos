...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click', '.tv-show-tile', function (event) {
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Favourite Movies and TV-Shows (Fresh Tomatoes)</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <h2>{movie_title}</h2>
    <h3>Duration: {movie_duration}<h3>
</div>
'''

# A single tv_show entry html template
tv_show_tile_content = '''
<div class="col-md-6 col-lg-4 tv-show-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <img src="{poster_image_url}" width="220" height="342">
    <h2>{tv_show_title}</h2>
    <h3>Seasons: {tv_show_seasons}<h3>
</div>
'''
...
#Added new function for tv_show tiles content
def create_tv_show_tiles_content(tv_shows):
    ...
    for tv_show in tv_shows:
        ...
        tv_shows_content += tv_show_tile_content.format(
            ...
            trailer_youtube_id=trailer_youtube_id,
            tv_show_seasons=tv_show.show_seasons
        )
...
def open_videos_page(movies, tv_shows):
    ...
    # Replace the movie tiles placeholder generated content
    rendered_video_content = main_page_content.format(
    create_movie_tiles_content(movies),
    create_tv_show_tiles_content(tv_shows))

    # Output the file
    output_file.write(main_page_head + rendered_video_content)
    output_file.close()
